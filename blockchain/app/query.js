...
var logger = utils.getLogger('Jeadigital-Rebuild_lives-App:[Query.js]');
...
var queryLogin = async function(peer, channelName, chaincodeName, args, orgName,fcn) {
	try {
		console.log(orgName);
		console.log(peer);
	...
	console.log(peer+'XXXXXXXXX'+chaincodeName+fcn+args+peer+channelName+username+org_name+'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx');
		// send query
		var request = {
			targets : peer, //queryByChaincode allows for multiple targets
			chaincodeId: chaincodeName,
