...
import { AuthorityloginService } from './authoritylogin.service';
...
export class AuthorityloginComponent {
  ...
  constructor(private route: Router, private obj: FormBuilder, private authoritylogin: AuthorityloginService,
  ...
  userRegister() {
    ...
    this.authoritylogin.submitser(args).subscribe(
      res => {
        console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>" + this.roleChange);
        console.log("first..");
        console.log(res);
  ...
  login() {
    ...
    this.authoritylogin.authenticate(args).subscribe(
      res => {
        console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>" + this.roleChange);
        console.log("first..");
        console.log(res);
   ...
   */
        ...
        if (status == true && role == "HouseOwner") {
          console.log("Status-----------" + status);
